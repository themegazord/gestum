...
new class extends Component {
    ...
    public string $acao = 'pagamento';
    public string $verbo = 'pagar';
    ...
    public function categorias(): Collection
    {
        return \App\Models\Categoria::query()
            ...
            ->where('tipo', \App\Enums\TipoCategoria::DESPESA)
            ->get()
    ...
    public function lancamentos(): \Illuminate\Pagination\LengthAwarePaginator
    {
        return \App\Models\Lancamento::withTrashed()
            ...
            ->where('lancamentos.tipo', \App\Enums\TipoCategoria::DESPESA)
    ...
    {
        return $this->view()->layout('layouts.authenticated')->title('Listagem - Contas a Pagar');
    }
}
...
<div class="container">
    ...
    <x-autenticado.lancamentos.table-lancamentos verbo="pagar" :headers="$headers"/>
