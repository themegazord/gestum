        ...
        <x-menu activate-by-route>
            ...
            <x-menu-sub title="Contas a receber" icon="o-arrow-trending-up">
                <x-menu-item title="Recebimentos" icon="o-banknotes"
                             link="{{ route('autenticado.contas-receber.listagem') }}"/>
            ...
            <x-menu-sub title="Cadastros" icon="o-folder-open">
                <x-menu-item title="Categorias" icon="o-tag"
                             link="{{ route('autenticado.cadastros.categorias.listagem') }}"/>
                <x-menu-item title="Métodos de Pagamento" icon="o-banknotes" link="{{ route('autenticado.cadastros.metodos-pagamentos.listagem') }}"/>
            </x-menu-sub>
            ...
            <x-menu-sub title="Contas bancárias" icon="o-building-library">
                ...
                <x-menu-item title="Contas" icon="o-wallet"
